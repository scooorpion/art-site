          ...
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center space-x-1">
              ...
              <motion.button
                ...
                className="relative flex items-center justify-center p-2 hover:bg-[var(--accent)]/20 transition-colors"
                style={{ borderRadius: '1rem' }}
                whileTap={{ scale: 0.95 }}
                whileHover={{ scale: 1.05 }}
              >
                    ...
                    return (
                      ...
                      >
                        <motion.button
                          ...
                          className={clsx(
                            'w-full flex items-center space-x-4 px-4 py-4 transition-all duration-300 text-left relative group',
                            isActive
